...
def extract_stamps(framelocalbz2, thisframeIDs):
    ...
    for ii in thisframeIDs:
        ...
        try:
            ...
            stamp['wcs'].header.update('OBJIDR10', objids[ii], comment='SDSS DR10 Object ID')
            stamp['wcs'].header.add_history('STAMP by MORFOMETRYKA, %s, F.Ferrari' % time.asctime() )          
            ...
            print 'ERR: extracting stamps id', objids[ii]
        ...
        if readPSF_status !=0:
            print 'ERR: generating PSF (read_PSF)' 
